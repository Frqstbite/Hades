...
--
------------------------------------------------------------------------------------------------------------------------
local __ftCache = require((...) .. ".footable")("classy")
local __classtag = {}
...
local function _classFinalize(klass)
	...
	if klass.__super__ then
		...
		-- This might mess some things up. TODO: Test if this messes things up. YES THIS MESSES THINGS UP REFER TO LINE 250
...
local function _classCall(klass, ...)
	return klass:new(...)
end
